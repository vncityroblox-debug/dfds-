                                ...
                                <tbody>
                                    <?php foreach ($listLogs as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span class="badge bg-success-gradient"><?= format_cash($row['sotientruoc']) ?>đ</span>
                                            </td>
                                            <td class="text-right"><span class="badge bg-danger-gradient"><?= format_cash($row['sotienthaydoi']) ?>đ</span></td>
                                            <td class="text-right"><span class="badge bg-primary-gradient"><?= format_cash($row['sotienhientai']) ?>đ</span>
                                            </td>
