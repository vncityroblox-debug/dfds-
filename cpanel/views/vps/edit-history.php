...
if (isset($_GET['id']) && $data_user['level'] == 'admin') {
    $id = Anti_xss($_GET['id']);
    $rows = $db->get_row("SELECT * FROM `tbl_purchased_cloudvps` WHERE `id` = '" . $id . "'");
    if (!$rows) {
        new Redirect("/cpanel/vps/history");
    }
    $result = infoListVps($rows['vps_id']);
    ...
    $row = $db->get_row("SELECT * FROM `tbl_purchased_cloudvps` WHERE `id` = '" . $id . "'");
                ...
                <div class="card custom-card">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-footer">
                            <a href="/cpanel/vps/history" class="btn btn-danger waves-effect">QUAY LẠI</a>
