...
<head><!-- Meta Data -->
    ...
    <link rel="icon" href="/assets/images/favicon.png" type="image/x-icon"> <!-- Choices JS -->
    <script src="<?= DOMAIN ?>/cpanel/assets/libs/choices.js/public/assets/scripts/choices.min.js"></script> <!-- Main Theme Js -->
    <script src="<?= DOMAIN ?>/cpanel/assets/js/main.js"></script> <!-- Bootstrap Css -->
    <link id="style" href="<?= DOMAIN ?>/cpanel/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet"> <!-- Style Css -->
    <link href="<?= DOMAIN ?>/cpanel/assets/css/styles.min.css" rel="stylesheet"> <!-- Icons Css -->
    <link href="<?= DOMAIN ?>/cpanel/assets/css/icons.css" rel="stylesheet"> <!-- Node Waves Css -->
    <link href="<?= DOMAIN ?>/cpanel/assets/libs/node-waves/waves.min.css" rel="stylesheet"> <!-- Simplebar Css -->
    <link href="<?= DOMAIN ?>/cpanel/assets/libs/simplebar/simplebar.min.css" rel="stylesheet"> <!-- Color Picker Css -->
    <link rel="stylesheet" href="<?= DOMAIN ?>/cpanel/assets/libs/flatpickr/flatpickr.min.css">
    <link rel="stylesheet" href="<?= DOMAIN ?>/cpanel/assets/libs/@simonwep/pickr/themes/nano.min.css"> <!-- Choices Css -->
    <link rel="stylesheet" href="<?= DOMAIN ?>/cpanel/assets/libs/choices.js/public/assets/styles/choices.min.css">
    <link rel="stylesheet" href="<?= DOMAIN ?>/cpanel/assets/fontawesome/css/all.min.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">

    <script src="<?= DOMAIN ?>/cpanel/assets/js/jquery-3.6.0.js"></script>
    <!-- Simple Notify CSS -->
    ...
    <script src="<?= DOMAIN ?>/cpanel/assets/ckeditor/ckeditor.js?v=<?= time() ?>"></script>
